...
func TestVersionDefaults(t *testing.T) {
	if Version != "0.4.0" {
		t.Errorf("expected default Version to be 0.4.0, got %s", Version)
	}
	...
	if !strings.Contains(full, "0.4.0") || !strings.Contains(full, "ExciteCreation") || !strings.Contains(full, "https://github.com/AhmadShamli/Funnel") {
